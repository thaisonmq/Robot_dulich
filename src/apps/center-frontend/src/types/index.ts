...
export interface Health {
  ...
  odom_arrival_fresh?: boolean;
  odom_timestamp_valid?: boolean;
  odom_clock_skew_seconds?: number;
  imu_arrival_fresh?: boolean;
  imu_timestamp_valid?: boolean;
  imu_clock_skew_seconds?: number;
  ...
  localization_diagnostics?: Record<string, unknown>;
  map_version?: number;

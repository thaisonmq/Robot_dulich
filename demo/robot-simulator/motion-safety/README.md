...
E-stop, bumper, cliff, range, mất `/scan` quá 280 ms hoặc mất command đều xuất zero ngay, không qua smoothing. Vùng STOP dùng footprint LiDAR-calibrated 0,40 × 0,36 m cộng clearance động (tối thiểu 0,10 m); vùng SLOW nằm xa hơn 0,20 m. Sau khi hết vật cản phải sạch liên tục 400 ms.

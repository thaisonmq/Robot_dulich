...
E-stop, bumper, cliff, range, mất `/scan` quá 280 ms hoặc mất command đều xuất zero ngay, không qua smoothing. Vùng STOP dùng footprint thật 0,30 × 0,20 m cộng clearance động (tối thiểu 0,04 m); vùng SLOW nằm xa hơn 0,10 m. Sau khi hết vật cản phải sạch liên tục 200 ms.
